...
Future<void> _runAppAsync(Future<Map<String, dynamic>?> payloadFuture) async {
  // Espera el payload de Swift
  final payload = await payloadFuture;

  // Obtén el valor deseado del payload
  final greetingMessage = payload?['greeting'] as String?;

  // Llama a runApp con el valor del payload
  runApp(SecondApp(message: greetingMessage));
}
